...
#
# secure-dashboard.sh
# Health Network Dashboard - Secure Deployment (Nginx + SSL + Basic Auth + Fail2Ban + UFW)
#
...
DASHBOARD_DIR="/root/health-network"
...
echo "============================================================"
echo " Health Network Dashboard - Secure Deployment"
echo "============================================================"
...
LEGACY_SERVICES="dashboard.service 6g-dashboard.service health-network.service node-dashboard.service"
...
# Health Network Dashboard - Nginx Configuration
...
server {
    ...
    auth_basic "Health Network Dashboard - Restricted Access";
...
echo "   سپس: cd /root/health-network/config && docker-compose up -d"
...
[Unit]
Description=Health Network Dashboard Server
